...
if __name__ == "__main__":
    ...
    send_commands_to_devices(devices, show=command, filename="page502_19_task4_OTVET_result.txt")
    send_commands_to_devices(devices, config="logging 10.5.5.5", filename="page502_19_task4_OTVET_result.txt")